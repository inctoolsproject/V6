...
cl = LINETCR.LINE()
cl.login(token="EncZCrCDsalzHblt2XFa.evpx2S9ig4v6qls5BZETwG.7HHAVSXEnJxOnwBgnrFO55JslaCSdN4gg5zXhzuEsmI=")

ki = LINETCR.LINE()
ki.login(token="En0qkVpsGXdLGUPUX9S9.B0VJ3wr3JKBPPUUO3wJNcq.5CKMi6RRx2KNfx2HSwKTQi6x5R1woziqtz4QtJNPxqQ=")

kk = LINETCR.LINE()
kk.login(token="EnOiVWsdIGkosGi8xg22.PQmX8Tb2ghCzAV+X/gdJuG.1idpAoU2k9lDbMBpW839GmdOWmLxCNsYPxaLv9wvtmE=")

kc = LINETCR.LINE()
kc.login(token="En0cVsCRo5xmBdUGlZ67.y5t33ie/K562yjUYJcEg5W.w84mLmTQPW0s8ZVbp4y2rFix6R2yb91yshLT8MHmqMk=")

ks = LINETCR.LINE()
ks.login(token="EnDLRLl9LIbBK4rhBDN4.Ke9qBpPW4N6TMmKbe7WvTa.bEk+NRIeOTBjpaDfukgB30SBnB1n7JdcChPhv1DVDYk=")

ka = LINETCR.LINE()
ka.login(token="EmQJlyCBSq8hFdqMahNa.k+rDc9Xny7uVzWMsLUi6EG.lVcnhmmXoPSofIQAu6llYNfpMB+eJjFN4U/AvGgwp10=")

kb = LINETCR.LINE()
kb.login(token="EmCB2xlqdBbzEycbU1y6.cxLLVSir2kK6cEcS4tblLG.GApG19aedonXNA3mFeA6SlteZyEYGL41aIp5z1CTfxw=")

ko = LINETCR.LINE()
ko.login(token="EmRiDTmhKPxConsE94Ya.wIH+KOiITb2BdUKRbRqmsG.3YiFNFxUd2ZFW4xkcvr6JFzLBhmvc2vGVnJGPcgwPa0=")

kp = LINETCR.LINE()
kp.login(token="EmCAMQI1tGYifYYnekWc.0VXrDgTGjBBKaoktIK49ha.StP0QuxJ69nWiR4hNvMzb36kVSpqx31veZDdmNb2DbA=")

kq = LINETCR.LINE()
kq.login(token="Em4BUCk1fsWQznnWFQz9.8kXnuVl0A/HEjPPSzsFXQq.+2gqREM1ZbVJXPH/TazVg64hEh7jHYQOVc4DZN7ZPVM=")

kr = LINETCR.LINE()
kr.login(token="EmsycGr9rw3Yu36K2SX7.iQx4h9c6+KlqYsMHQrt21W.1aL8Wgj3hcZ5GHfWQbLRgWsLJmqSrUyVamaB6YDzoPc=")

kl = LINETCR.LINE()
kl.login(token="EmxV9Wr2svZCHbDMRva5.GvoVo0dENexwnyrTI4Wm1q.69zs+9cWJEJiiFs4DRzz8CcSz1is5dNlr9pAVjVyx80=")

kt = LINETCR.LINE()
kt.login(token="EmkxjizFc30jnZq63Drb.RCCfStZo5+eMVfD3tJcCgW.wAbwDjQmx9dN/0TlrBU6nL3bz1G8P8aMRnPUuDr5bXw=")

ku = LINETCR.LINE()
ku.login(token="Em3epHpoJPt6Txx15IP8.HoBLfY+U15z4571sFJLbca.74ML9sl+CrjGaYiyu2rtJ5JsU0oMcnQFOpK/q3PJpHw=")

kv = LINETCR.LINE()
kv.login(token="EmHhtJuTg2160b4fOpYf.x2xsOMun+KUK20uvR3A7ZW.q4xqKn5birTqQNVeF8+KcRiBX5xWSePfMnTB7UqH8nc=")

kw = LINETCR.LINE()
kw.login(token="EmlLEbaOD59UIujo89n8.wAM3niQ1Ixmt+phoAkWkUa.cTwVaIbt6yDlNlRqtOymjqSNalRkr1ETqJCg/3jotj4=")

kx = LINETCR.LINE()
kx.login(token="EmgsdonpExGAPgZmvSz5.ZDx4K1kAbSCf/dQ2fU/sTq.rgC7xgoEV65gJBLkS9aWerfiXWzAPdS2Db+zr6BZdHY=")

ky = LINETCR.LINE()
ky.login(token="Emruql2Dq5A0E9jHTcw4.Vvpu1f3J+U5eFf8Rjferra.rUEGKIT0kYcR7rCB081iqa3w3f08PtjDl7O6b8XRrgw=")

kz = LINETCR.LINE()
kz.login(token="Em46idZ51LvzqCtnubob.G10LpgCJC4E5ua4IoZwgoW.amy3QY5ZPEwrjzg2TAKhV4Y38Tu0WD0Ek3oEGE+OqsU=")

print "=====StreetPunkBot====="
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage =""" [PunkBot V4.7.1]
====================
    ⛥ คำสั่งบอททั้งหมด
====================
...
"""
KAC=[ki,kk,kc,ks,ka,kb,ko,kp,kq,kr,kl,kt,ku,kv,kw,kx,ky,kz]
...
Jmid = ko.getProfile().mid
Kmid = ko.getProfile().mid
Lmid = ko.getProfile().mid
Mmid = ko.getProfile().mid
Nmid = ko.getProfile().mid
Omid = ko.getProfile().mid
Pmid = ko.getProfile().mid
Qmid = ko.getProfile().mid
Rmid = ko.getProfile().mid
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Thanks for add me Line Slef BOT!",
    "lang":"JP",
    "comment":"Autolike",
    "likeOn":False,
    "commentOn":False,
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
              ...
              if msg.from_ in admin:
                  ...
                  invsend = 0
                  Ti = cl.reissueGroupTicket(msg.to)
                  ky.acceptGroupInvitationByTicket(msg.to,Ti)
                  G = cl.getGroup(msg.to)
                  G.preventJoinByTicket = True
                  cl.updateGroup(G)
                  Ticket = cl.reissueGroupTicket(msg.to)
              ...
              if msg.from_ in admin:
                  ...
                  invsend = 0
                  Ti = cl.reissueGroupTicket(msg.to)
                  kz.acceptGroupInvitationByTicket(msg.to,Ti)
                  G = cl.getGroup(msg.to)
                  G.preventJoinByTicket = True
                  cl.updateGroup(G)
                  Ticket = cl.reissueGroupTicket(msg.to)				  
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            klist=[ki,kk,kc,ks,ka,kb,ko,kp,kq,kr,kl,kt,ku,kv,kw,kx,ky,kz]
                            kicker=random.choice(klist)
        ...
        #----------------Fungsi Kick User Target Start----------------------#
                  ...
                  if msg.from_ in admin:
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    klist=[cl,ki,kk,kc,ks,ka,kb,ko,kp,kq,kr,kl,kt,ku,kv,kw,kx,ky,kz]
                                    kicker=random.choice(klist)
                                    kicker.kickoutFromGroup(msg.to,[target])
                                    print (msg.to,[g.mid])
                                except:
