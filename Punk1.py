...
ki = LINETCR.LINE()
ki.login(token="EmOYKZHJrm86NNn90mN4.0HF+elPyZALb85Jb4rZuDa.ET3RV8//TMXLUBpaRnEf58Gzygo3N4orogS68/rrTeU=")

kk = LINETCR.LINE()
kk.login(token="EmKhYeib9MSvOuP7XR43.uLOi2aSaaXs1uT7TQsfnuW.iwv2LMF7dO+uRiZSyx56ETArJcQC10xnXMLrdNiw/zs=")

kc = LINETCR.LINE()
kc.login(token="Eme7wn53C0goDcD3jK97.y5t33ie/K562yjUYJcEg5W.q6yykasS3zDysFVUIt77LJelXECb8ktSx6MU/lBowSU=")

ks = LINETCR.LINE()
ks.login(token="EmLjpJ6J1xTbKnYUTSa2.n8h5zovxBceOm+L+gG8OKG.iVcdGd1CWUJrIj6ndnlWc/ajRgASqIyhXFMlgbJVamM=")
...
admin=["u1153d7dacf481b857a40b4b96f37ad5a"]
wait = {
    'contact':True,
    'autoJoin':True,
